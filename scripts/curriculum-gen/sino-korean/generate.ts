...
/**
 * Help texts for Sino-Korean numbers.
 * Guidelines:
 * - Don't repeat the Korean/romanization shown elsewhere in the UI
 * - Don't rely on order (numbers are randomized within stages)
 * - Use romanization when explaining patterns (users may not read Hangul yet)
 * - Max ~170 chars
 */
...
function generateCurriculum(): Curriculum {
    ...
    const stages: Stage[] = [
        ...
        },
        {
            ...
            numbers: toNumberEntries([11, 22, 33, 44, 55, 66, 77, 88, 99, ...sparseRange(31, 99, 50, random)]),
        },
        {
